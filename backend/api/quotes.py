...
@router.post("/quotes")
async def api_quotes(request: Request):
    """Get LTP/OHLC quotes for a symbol via the external API."""
    ...
    try:
        ...
        logger.exception("Unexpected error in quotes endpoint")
